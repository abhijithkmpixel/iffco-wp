...
<section class="hero__banner <?php
                                ...
                                $sustainability__banner__element__color = get_field('sustainability_banner_bottom_element_color');
                                ...
                                ?>
                                " style="--bg-color: <?php echo $banner__bg__color; ?>; --element-color:<?php echo $sustainability__banner__element__color; ?> ">
    ...
    <div class="container">
        ...
        <?php if (have_rows('flexible_content')) : ?>
            <?php while (have_rows('flexible_content')) : the_row(); ?>
                ...
                <?php if (get_row_layout() == 'sustainability_title') : ?>

                    <div class="row">
                        <div class="col-12 col-lg-9 col-xl-8">
                            <h2 class="title__primary title__primary--lg text__sentence">
                                <?php echo the_sub_field('sustainability_title_content'); ?></h2>
                        </div>
                    </div>

                <?php elseif (get_row_layout() == 'sustainability_subtitle') :
                ?>
                    <div class="row">
                        <div class="col-12 col-lg-9 col-xl-8">
                            <h5 class="title__tertiary"><?php echo get_sub_field('sustainability_subtitle_content'); ?></h5>
                        </div>
                    </div>

                <?php elseif (get_row_layout() == 'content_area_layout') :
                ?>
                    <div class="row pb-3">
                        <div class="col-12 col-lg-9 col-xl-9">
                            <?php echo get_sub_field("content_area_content"); ?>
                        </div>
                    </div>

                <?php elseif (get_row_layout() == 'sustainability_grid') :
                ?>

                    <?php if (have_rows('sustainability_grid')) : ?>
                        <div class="row solutions__card__grid">
                            <?php while (have_rows('sustainability_grid')) : the_row();
...
<section class="enduring__values" style="--bg-color:<?php echo $ev__bg; ?> ">
    <div class="container">
        <h2 class="title__primary text-center text-white">
