...
?>
<?php get_header(); ?>
<section class="hero__banner hero__banner--static--img" style="--bg-color: #ee2e24">
    <div class="container">
        <div class="hero__banner__content">
            <h1>Welcome to the world of IFFCO</h1>
            <p>
                <strong>

                    With a portfolio of over 80 brands and operations
                    <br />

                    in 49 countries. IFFCO is one of the leading and most
                    <br />

                    diversified business groups in the Middle East.

                </strong>
            </p>
            <div class="hero__banner__content__btn__wrap">
                <a href="#" class="cta__primary cta__primary--light">Quick facts
                ...
                <a href="#" class="cta__primary cta__primary--light">Our history
    ...
    <img src="./uploads/home/bg.png" alt="" />
    <!-- <div class="overlay__grid__wrap">

    <div class="overlay__grid__wrap__item" style="--card-bg: #ee2e24">

      <img

        src="./uploads/og/og1.png"
      ...
      <div class="overlay__grid__wrap__item__footer__icon ms-auto">
        ...
        <img src="./uploads/og/ogi1.png" alt="" />
    ...
    <div
      ...
      class="overlay__grid__wrap__item overlay__grid__wrap__item--lines"

      style="--card-bg: #db2129; --line-color: #b53028">

      <div class="overlay__grid__wrap__item__header">

        <h3><span class="counters" data-number="80">80</span>+</h3>
      ...
      <div class="overlay__grid__wrap__item__footer__icon">
        ...
        <img src="./uploads/og/ogi2.png" alt="" />
    ...
    <div class="overlay__grid__wrap__item" style="--card-bg: #a12b21">

      <div class="overlay__grid__wrap__item__header">

        <h3><span class="counters" data-number="50">50</span>+</h3>
      ...
      <div class="overlay__grid__wrap__item__footer__icon">
        ...
        <img src="./uploads/og/ogi3.png" alt="" />
